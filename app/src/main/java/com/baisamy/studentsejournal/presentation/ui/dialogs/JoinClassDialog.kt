    ...
    Dialog(
        ...
        Card(
            ...
            Column(
                ...
                Text(
                    text = stringResource(id = R.string.join_class),
                    style = Title
                )
                Spacer(modifier = Modifier.height(16.dp))
                Text(
                    modifier = Modifier.fillMaxWidth(),
                    text = stringResource(id = R.string.class_token),
                    style = Body
                )
                ...
                MainTextField(
                    ...
                    hint = stringResource(id = R.string.class_token)
                )
                Spacer(modifier = Modifier.height(16.dp))
                ActionButton(
